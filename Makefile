#############################################################################
# Makefile for building: ImageStudio
# Generated by qmake (3.1) (Qt 6.8.1)
# Project:  ImageStudio.pro
# Template: app
# Command: C:/Qt/6.8.1/mingw_64/bin/qmake.exe -o Makefile ImageStudio.pro
#############################################################################
...
Makefile: ImageStudio.pro C:/Qt/6.8.1/mingw_64/mkspecs/win32-g++/qmake.conf C:/Qt/6.8.1/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile ImageStudio.pro
